...
{
    e.preventDefault();
    const formData = nex FormData(formulaire);
    ...
    /*
        ...
        La méthode utilisée pour envoyer la requête
        les informations contenues dans l'entête de la requête et le corps de la requête.
    */
    fetch(url,{
        method : "POST",
        harders : {"x-api-key": api_key},
        body: formData
    }).then(checkResponse);
}
