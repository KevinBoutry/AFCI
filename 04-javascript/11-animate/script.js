...
function animation1()
{
    /*
        ...
        Le 1er est la liste des keyframes que l'élément HTML devra parcourir.
        Le 2nd est un objet contenant les options de l'animation

        * Les keyframes peuvent être donné sous forme de tableau ou d'objet.
    */
...
function animation3()
{
    // On a la possibilité de ranger l'objet retourné par animate dans une variable pour accéder à de nouvelles méthodes.
...
async function animation5()
{
    ...
    // playState indique l'etat de l'animation
    switch(anime5.playState)
    {
        // idel est l'état par défaut, celui d'attente
        case "idle":
            anime5.play();
            ...
            break;
            // running est l'état quand l'animation est en cours.
        case "running":
            anime5.pause();
