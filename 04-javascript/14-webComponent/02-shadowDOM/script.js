...
/*
    ...
    De même les scripts et styles du shadow DOM n'influent pas sur ceux du parent.
...
const shadowclose = open.attachShadow({mode:"closed"});
...
/*
    Dans l'exemple suivant, chacun des h1 ne sont afectés que par le style de leur propre DOM.

    A noter que j'utilise des feuilles de style interne dans cet exemple, mais il est tout à fait possible d'ajouter une feuille de style externe.

    On notera aussi le selecteur css ":host" qui est utilisable uniquement en shadowDOM et qui correspondera au "root" ou au "body" de notre DOM fantôme
*/
...
/*
    Si je tente de sélectionner tous mes h1, seul celui du DOM principal sera trouvé.

    Pour sélectionner ceux des DOM fantômes, il faudra soit faire la recherche dans le shadowRoot retourné par le attachShadow, soit si il est "open" via l'attribut shadowRoot de l'host fantôme.
*/
...
/*
    ...
    Pour cela je vais lier directement un shadow DOM à nos customElement dans son constructor.

    Je peux ainsi ajouter son style directment sous forme de la blise "style" ou "link".
*/
