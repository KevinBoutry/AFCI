...
/*
    ...
    A la différence de la classe abstraite, l'interface ne contiendra que des déclarations, mais aucune définition.
    A la différence des types, l'interface sera réservée aux objets et pourra être redéfinie (fusionnée)
*/
